...
def main():
    """
    Based on runtime arguments, will either generate txt of IMDb IDs based on filters
    added to movie_id_selector.py, or fetch API data and load into local data warehouse.
    """
